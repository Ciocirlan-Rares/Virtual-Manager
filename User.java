...
public class User {
    ...
    public static void App_user(String username) {
        frame_u = new JFrame("Welcome to Virtual Manager, "+username);
        ...
        mb.add(m1);
        m11 = new JMenuItem(new AbstractAction("Sell"){
            @Override
        ...
        m1.add(m11);
        m12 = new JMenuItem(new AbstractAction("Add") {
            @Override
            public void actionPerformed(ActionEvent e) {
                try{
                    frame_u.setVisible(false);
    ...
    protected static void setFrame_b() throws Exception {
        ...
        buy = new JButton(new AbstractAction("Sell") {
            @Override
            public void actionPerformed(ActionEvent e) {
                database d = new database();
    ...
    protected static void setFrame_s () throws Exception{
        ...
        JLabel label1 = new JLabel("Amount to add");
        amount_s = new JTextField(5);
        sell = new JButton(new AbstractAction("Add") {
            @Override
            public void actionPerformed(ActionEvent e) {
                database d = new database();
